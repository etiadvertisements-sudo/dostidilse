...
import { API, CONTACT_EMAIL } from "@/lib/constants";
      ...
      <section className="py-16 md:py-24">
        <div className="ddls-container grid lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            <div className="text-xs tracking-[0.28em] uppercase text-[#D99F80] font-medium">Get In Touch</div>
            <h1 className="mt-4 font-serif text-5xl sm:text-6xl tracking-tight text-[#2C3E42] leading-[1.05]">
              Say hello.
              <br />
              <span className="italic text-[#5A8896]">We&rsquo;ll say it back.</span>
            </h1>
            <p className="mt-6 text-[#5C757B] leading-relaxed text-lg">
              Whether you&rsquo;d like to volunteer, partner with us, sponsor a school visit,
              or simply share a kind word — our door is always open.
            </p>
            ...
            >
              ...
              <div>
                <div className="text-xs tracking-[0.22em] uppercase text-[#5C757B]">Email us</div>
            ...
            <div className="mt-10 bg-[#F2EFE9]/60 border border-[#EBE7E0] rounded-[1.5rem] p-6">
              ...
              <p className="mt-3 font-serif italic text-lg text-[#2C3E42] leading-relaxed">
                &ldquo;The smallest message, the quietest offer, can begin a long friendship.&rdquo;
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-4">
              <label className="text-xs tracking-[0.22em] uppercase text-[#5C757B]">Your message</label>
              <textarea
                required
                rows={7}
                value={form.message}
